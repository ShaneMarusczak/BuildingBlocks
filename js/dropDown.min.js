...
function showDropDown(a,c){var d=document.getElementById(a);Object.keys(c).forEach(function(a){var b=document.createElement("a");b.classList.add("drop-down-link");b.innerText=a;b.href=c[a];b.target="_blank";d.appendChild(b)})}function hideDropDown(a){for(a=document.getElementById(a);a.firstChild;)a.removeChild(a.lastChild)};
